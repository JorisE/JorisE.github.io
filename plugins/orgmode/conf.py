...
BLOG_AUTHOR = "JHA Engbers"  # (translatable)
BLOG_TITLE = "Le Website"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://jorise.github.io"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://joris.engbers.info/"
BLOG_EMAIL = "info@jorisengbers.nl"
BLOG_DESCRIPTION = "This is a website about things you might find on the internet."  # (translatable)
